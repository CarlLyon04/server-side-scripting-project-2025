...
<h1 class="mb-4">Delete Student</h2>
<form>
<div class="mb-3">
    ...
    <div class="alert alert-danger" role="alert">
        Warning: Are you sure you wish to delete this student record?
    </div>
    <br>
   <button type="submit" class="btn btn-danger">Delete Student</button>
   <a class="btn btn-primary" href="" role="button">Go back to students index page</a>
</form>
